...
export default class ChatMessage extends React.Component {
  ...
  render() {
    ...
    let avatar = <img className="avatar" src={require('../images/default_avatar.jpg')} />;
    if (this.props.chatmessage.from_bot) {
      avatar = <img className="avatar" src={require('../images/kindly-happy.svg')} />;
    }
    let buttons = null;
      ...
      buttons = (
        <div className="buttons">
          {this.props.chatmessage.buttons.map((button) => {
            ...
            //     {button.label}
            // </a>
            return <Button key={button.id} button={button} quickReply={this.props.quickReply} />;
          })}
        </div>
      );
    }
    return (
      <div key={this.props.chatmessage._id}>
        <div className={wrapperClassNames}>
          {avatar}
          <div className="message">{this.props.chatmessage.message}</div>
        </div>
        {buttons}
      </div>
    );
